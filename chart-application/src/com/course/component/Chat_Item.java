...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    if(label!=null){
        label.setIcon(new ImageIcon(getClass().getResource("/com/course/icon/tick.png")));
    }
    }
     public void seen(){
    if(label!=null){
        label.setIcon(new ImageIcon(getClass().getResource("/com/course/icon/double_tick.png")));
    }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.course.swing.JIMSendTextPane();
    ...
    private com.course.swing.JIMSendTextPane txt;
